...
def transcribe_german_to_ass(
    ...
    lines = [
        ...
        "Style: TikTok,Segoe UI,52,&H00FFFFFF,&H00FFFFFF,&H00101010,&H70000000,"
...
class App(tk.Tk):
    ...
    def export(self):
        ...
        output = filedialog.asksaveasfilename(
            ...
            initialfile="SchlauWutzie_V22_FINAL.mp4",
        )
        ...
        self.set_status(
            "V22: Intro + Hauptvideo + Untertitel werden gerendert …"
        )
    ...
    def _export_worker(self, output):
        try:
            ...
            try:
                ...
                # Auto-generate subtitles on export if the user has not already
                # created them with the button.
                if not self.subtitle_path:
                    ...
                    temp_files = [temp_main, subtitled]
                else:
                    temp_files = [temp_main]

                # Intro is kept clean; subtitles belong to the spoken main video.
                prepend_intro(
                    str(INTRO_VIDEO),
                    str(final_main),
                    output,
    ...
    def _export_done(self, output):
        ...
        self.set_status(
            "V22: Intro + Hauptvideo + Untertitel fertig."
        )
